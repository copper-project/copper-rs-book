...
Fragment count and payload length are derived from that geometry and the configured
symbol capacity; fragment kind is implicitly CopperList. The reassembled record
