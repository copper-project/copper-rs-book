...
If you have not added the monitor yet, start with [Adding the Console Monitor](./monitoring.md).
If you want offline stats from a log, see [Exporting Data to Other Formats](./export-formats.md).
